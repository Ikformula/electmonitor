...
@section ('title', 'Added Elections | '. app_name() . ' | ' . __('labels.backend.access.users.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    Elections <small class="text-muted"> added</small>
                </h4>
            </div><!--col-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group" aria-label="User Actions">
                                       <a href="{{route('single.results', $election)}}" class="btn btn-info"><i class="fas fa-eye" data-toggle="tooltip" data-placement="top" title="View"></i></a>

                                        @role('field_agent')
                                    <a href="{{route('admin.election.dataforms', $election)}}" data-toggle="tooltip" data-placement="top" title="enter voting results and demographics for this election" class="btn btn-outline-primary"><i class="fas fa-list"></i> Enter data</a>
                                        @endrole
